package com.ddominguezh.spring.core.shared.domain.config;
...
import com.ddominguezh.spring.core.shared.domain.config.handler.AuthorizationHandlerMethodArgumentResolver;
